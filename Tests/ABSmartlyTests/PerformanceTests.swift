...
final class PerformanceTests: XCTestCase {
	...
	func testHighFrequencyOperations() throws {
		...
		self.measure {
			for i in 0..<1000 {
				context.setAttribute(name: "attr_\(i % 100)", value: "value_\(i)")
			}
		}
	...
	func testGoalTrackingPerformance() throws {
		...
		self.measure {
			for i in 0..<100 {
				context.track("goal_\(i % 10)", properties: ["iteration": i])
			}
		}
	...
	func testCacheMemoryUsage() throws {
		...
		for i in 0..<100 {
			context.track("goal_\(i)", properties: ["data": String(repeating: "x", count: 100)])
		}
